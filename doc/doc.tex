...
network's confidence in its prediction. The resulting confidence values are
interpolated and displayed as a color-coded overlay, with warmer colors
indicating high-confidence regions, and cooler colors showing areas where
